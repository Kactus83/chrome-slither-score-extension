...
export class Score {
  constructor(playerId, playerName, value, startDate, endDate, extraTurn = false, overPlayed = false, scoreCounts = true) {
    ...
    this.overPlayed = overPlayed; // Indique si le score donne droit à un tour supplémentaire
