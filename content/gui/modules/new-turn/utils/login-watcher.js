  ...
  observe() {
    ...
    this.observer = new MutationObserver(mutations => {
      mutations.forEach(mutation => {
        const bskhDiv = document.querySelector('#bskh');
        const bskhDivVisible = bskhDiv && bskhDiv.style.display !== 'none';
  
        if (!this.inProgressTriggered && mutation.type === 'attributes' && mutation.attributeName === 'style' && this.loginDiv.style.display === 'none' && !bskhDivVisible) {
